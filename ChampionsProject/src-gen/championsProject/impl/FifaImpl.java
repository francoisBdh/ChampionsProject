...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fifa</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link championsProject.impl.FifaImpl#getCountry <em>Country</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FifaImpl extends MinimalEObjectImpl.Container implements Fifa {
	/**
	...
	protected EClass eStaticClass() {
		return ChampionsProjectPackage.Literals.FIFA;
	}
	...
	public EList<Country> getCountry() {
		if (country == null) {
			country = new EObjectContainmentEList<Country>(Country.class, this, ChampionsProjectPackage.FIFA__COUNTRY);
		}
		return country;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ChampionsProjectPackage.FIFA__COUNTRY:
