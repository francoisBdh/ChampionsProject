...
public abstract class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	...
	protected EClass eStaticClass() {
		return ChampionsProjectPackage.Literals.PERSON;
	}
	...
	public void setAge(int newAge) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChampionsProjectPackage.PERSON__AGE, oldAge, age));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChampionsProjectPackage.PERSON__NAME, oldName, name));
	}
